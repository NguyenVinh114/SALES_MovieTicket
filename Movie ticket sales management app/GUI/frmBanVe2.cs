...
{
    public partial class frmBanVe2 : Form
    {
        ...
        private void frmBanVe2_Load(object sender, EventArgs e)
        {
            KhoiTosoGhe(4, 5);
        }
        ...
        {
            int x, y = 10, KhoangCachX = 140, KhoangCachY = 75, dem = 1;
            Button btnGhe;
